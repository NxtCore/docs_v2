  ...
  **Die Funktionen sind in die jeweiligen Menüs unterteilt.**
  ...
  <AccordionGroup>
    ...
    <Accordion title="Turniere" description="Beschreibung aller Funktionen in diesem Menü." icon="trophy">
      ...
      **Klicke hierzu auf das Icon <Icon icon="paintbrush-pencil" /> "Bearbeiten".**
          ...
          <Tab title="Stages">
            ...
            <Tabs>
              ...
              <Tab title="Match Config">
                ...
                \
                **Die Tiebreaker werden immer in Absteigender Reihenfolge angewendet.\
                Der Tiebreaker, der weiter oben steht, wird als erstes auf Anwendbarkeit überprüft.**

                <u>Legende zu Begriffen:</u>
                ...
                <u>Erklärung der einzelnen Tiebreaker:</u>

                - Punktevergleich: Es werden die Punkte in der Tabelle verglichen und die Teilnehmer an Hand Ihrer Punkte platziert.
